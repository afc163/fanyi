...
exports.iciba = function(data, simpleMode) {
  let firstLine = '';
  ...
  // sentence
  if (!simpleMode && data.sent && data.sent.length) {
    log();
...
exports.youdao = function(data, simpleMode) {
  let firstLine = '';
  ...
  // sentence
  if (!simpleMode && data.web && data.web.length) {
    log();
